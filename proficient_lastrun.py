...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed Aug 26 08:56:21 2015
...
expName = 'proficient'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/talithaford/Desktop/TalithasFiles/NeuralCodeTF/visneuro/proficient.psyexp',
...
# Initialize components for Routine "Begin_exp_block"
Begin_exp_blockClock = core.Clock()
text_2 = visual.TextStim(win=win, ori=0, name='text_2',
    text=u'That is the end of the trial.\n\nYou will now begin the experiment, there will be no feedback.\n\nPress left for gorillas\nPress right for kittens\nPress up for hedgehogs\n\nPress space bar to beging',    font=u'Arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0)
...
trials = data.TrialHandler(nReps=5, method='random', 
    extraInfo=expInfo, originPath=u'/Users/talithaford/Desktop/TalithasFiles/NeuralCodeTF/visneuro/proficient.psyexp',
...
for thisTrial in trials:
    ...
    if key_resp_3.corr == 1:
        ...
        msg = "No you fool! That's not right!"
    feedback.setText(msg)
    # keep track of which components have finished
    feedback_blockComponents = []
    feedback_blockComponents.append(feedback)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if feedback.status == STARTED and t >= (0.0 + (1.0-win.monitorFramePeriod*0.75)): #most of one frame period left
...
#------Prepare to start Routine "Begin_exp_block"-------
t = 0
Begin_exp_blockClock.reset()  # clock 
frameN = -1
# update component parameters for each repeat
key_resp_5 = event.BuilderKeyResponse()  # create an object of type KeyResponse
key_resp_5.status = NOT_STARTED
# keep track of which components have finished
Begin_exp_blockComponents = []
Begin_exp_blockComponents.append(text_2)
Begin_exp_blockComponents.append(key_resp_5)
for thisComponent in Begin_exp_blockComponents:
    if hasattr(thisComponent, 'status'):
        thisComponent.status = NOT_STARTED

#-------Start Routine "Begin_exp_block"-------
continueRoutine = True
while continueRoutine:
    # get current time
    t = Begin_exp_blockClock.getTime()
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
#-------Ending Routine "Begin_exp_block"-------
for thisComponent in Begin_exp_blockComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
